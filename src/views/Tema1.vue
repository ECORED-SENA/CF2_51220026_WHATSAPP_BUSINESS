  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1 Medición de las publicaciones 

    p(data-aos="fade-up") Día tras día los servicios de tecnología evolucionan constantemente, y en materia de comunicaciones una de las tradiciones era enviar mensajes de texto con un costo determinado, pero todo cambió tal como lo dice Gil (2021):

    .row.col-lg-10.m-auto.mt-5.cont_1_1(style="position:relative;")
      .col-lg-4.mb-4.mb-lg-0(style="place-self:center;position:relative")
        figure
          img(src="@/assets/curso/tema1/1.png" data-aos="fade-right")
      .col-lg-8.p-4(style="place-self:center;position:relative")
        p.mb-0(data-aos="fade-up") #[em WhatsApp] es una aplicación de mensajería instantánea que permite a los usuarios que disponen de un smartphone intercambiar mensajes de texto, imágenes, videos o audios de forma gratuita. #[strong Para poder hacerlo solamente se necesita tener conexión a internet o un servicio de datos contratado en el dispositivo.]
    ...
    .titulo-segundo
      h2#t_1_1 1.1 Recolección de indicadores en #[em WhatsApp Business]
    ...
    .titulo-segundo
      h2#t_1_2 1.2 Estadísticas web

    .row
      .col-lg-4.mb-4.mb-lg-0(style="place-self:center")
        figure
          img(src="@/assets/curso/tema1/4.png" data-aos="fade-right")
    ...
    .row.mt-5.col-lg-10.m-auto
      .col-lg-6.mb-4.mb-lg-0
        .h-100(style="background-color:#FFF1CB;border-bottom-right-radius:15px;border-bottom-left-radius:15px;")
    ...
    .row.mt-5
      .col-lg-4.mb-4.mb-lg-0
        .h-100(style="background-color:#BFF6FF;")
          .pb-4(style="background: rgb(0,100,117);background: linear-gradient(360deg, rgba(0,100,117,1) 73%, rgba(255,255,255,1) 73%);")
      ...
      .col-lg-4.mb-4.mb-lg-0
        .h-100(style="background-color:#FAEBCD;")
          .pb-4(style="background: rgb(255,215,106);background: linear-gradient(360deg, rgba(255,215,106,1) 73%, rgba(255,255,255,1) 73%);")
            figure.justify-content-center.d-flex
    ...
    .titulo-segundo
      h2#t_1_3 1.3 Tipos de indicadores
    ...
    .titulo-segundo
      h2#t_1_4 1.4 Medición de indicadores
    ...
    .row.col-xl-10.m-auto.mt-5
      .col-xl-6.mb-5.mb-xl-0
        .h-100.card__scale(style="background-color:#FFF1CB;")
          ...
          .p-4
            p.mb-0(data-aos="fade-up") Es el alcance logrado sin el uso de herramientas pagas como los anuncios de las redes sociales, es decir, los temas llegan a los diferentes usuarios de forma natural, por intermedio de la página de inicio o temas compartidos.
      .col-xl-6.mb-5.mb-xl-0
        .h-100.card__scale(style="background-color:#A6E9E2;")
          ...
          .p-4
            p.mb-0(data-aos="fade-up") Se logra como resultado de una campaña publicitaria después de realizar un pago en una de las plataformas.

    p.mt-5(data-aos="fade-up") #[strong Cuanto más alcance se tenga, más conciencia de marca tendrá; sin embargo, para que ese alcance sea recompensado, debe interactuar con su audiencia y realizar un seguimiento de sus interacciones para encontrar clientes potenciales.]
    ...
    .row.mt-5
      .col-xl-4.col-lg-6.mb-4.mb-lg-0
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
          ...
          .p-4(style="background-color:#00C1AB;position:absolute;width:100%;bottom:0;")
            p #[strong Tener una estrategia]
            p.mb-0 Para iniciar se requiere una estrategia puntual, no inicie sin ella.
      .col-xl-4.col-lg-6.mb-4.mb-lg-0
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
      ...
      .col-xl-4.col-lg-6.mb-4.mb-lg-0
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
          ...
          .p-4(style="background-color:#00C1AB;position:absolute;width:100%;bottom:0;")
            p #[strong Definir los beneficios]
            p.mb-0 ¿Qué beneficios se esperan conseguir con la campaña?
      .col-xl-4.col-lg-6.mt-4
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
          img(src="@/assets/curso/tema1/30.png")
          .p-4(style="background-color:#00C1AB;position:absolute;width:100%;bottom:0;")
            p #[strong Tener claro lo que se desea]
            p Debe tener claro qué quiere la empresa que haga la persona que los contacta para seguir en el proceso.
      .col-xl-4.col-lg-6.mt-4
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
          img(src="@/assets/curso/tema1/31.png")
          .p-4.pt-4.pb-3(style="background-color:#00C1AB;position:absolute;width:100%;bottom:0;")
            p #[strong Determinar el tiempo]
            p.mb-0 Determine el tiempo de la campaña, haciendo énfasis en 24/7, temporadas, fines de semana o días hábiles. A la mano debe tener el presupuesto de la misma.
      .col-xl-4.col-lg-6.mt-4
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
          img(src="@/assets/curso/tema1/32.png")
          .p-4.pb-5(style="background-color:#00C1AB;position:absolute;width:100%;bottom:0;")
    ...
    TabsA.color-acento-contenido.mt-5
      .tarjeta.color-acento-botones--borde.p-4(titulo="Tener nivel de tráfico")
        .row
          .col-lg-5.mb-4.mb-lg-0(style="place-self:center")
            h5 Tener nivel de tráfico
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Diseñar ofertas y promociones")
        .row
          .col-lg-5.mb-4.mb-lg-0(style="place-self:center")
            h5 Diseñar ofertas y promociones
            figure(data-aos="zoom-in-up" style="position:relative;")
    ...
    TabsB.color-acento-contenido.mt-5
      ...
      .py-4.py-md-5(titulo="Crear grupos de <em>WhatsApp</em> y listas de distribución" :icono="require('@/assets/curso/tema1/46.svg')")
        .row
          .col-lg-8.mb-4.mb-lg-0(style="place-self:center")
...
.tabs-b__tab__icon img
  filter: grayscale(1)
.tabs-b__tab.tabs-b__tab--active .tabs-b__tab__icon img
  filter: none
.tabs-b__tab
  border-bottom: 0
